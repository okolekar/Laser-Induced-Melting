...
n           =   10                  #number of nodes in x direction
m           =   45                  #number of nodes in y direction                      
...
depth       =   1                   #total depth to be simulated          # meters (m^2 for the 2D case)
t_end       =   45                 #End time for simulation              # dimensionless