...
Function ds_dt: -
=============================================================================================================================
The function updates the liquid-solid interface velocity according to the given formula: -
#############################################################################################################################
'''   
def ds_dt(hl,hs,Tl,Ts):
    return (1/ip.lambf)*((Tl/hl)+(Ts/hs))
'''
#############################################################################################################################
Function s_update: -
=============================================================================================================================
The function updates the liquid-solid interface according to the given formula: -
#############################################################################################################################
'''
def s_update(s,Tl,Ts, hl,hs):
    return (s + (ip.delt/ip.lambf)*(Tl/(hl)+Ts/(hs)))